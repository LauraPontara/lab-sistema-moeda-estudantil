...
|----|---------------------|
| **US01** | Como **usuário**, quero **fazer login no sistema com email e senha**, para **acessar minha conta e utilizar as funcionalidades disponíveis conforme meu perfil**. |
...
| ID | História de Usuário |
|----|---------------------|
| **US08** | Como **professor**, quero **enviar moedas a um aluno específico informando o motivo do reconhecimento**, para **recompensar boas atitudes, participação em aula ou desempenho acadêmico**. |
| **US09** | Como **professor**, quero **ser impedido de enviar moedas caso meu saldo seja insuficiente**, para **garantir que o sistema respeite os limites estabelecidos de distribuição**. |
| **US10** | Como **professor**, quero **consultar o extrato da minha conta**, para **visualizar meu saldo atual de moedas e o histórico de envios que realizei**. |
| **US11** | Como **professor**, quero **receber automaticamente 1.000 moedas a cada semestre**, para **continuar reconhecendo o mérito dos meus alunos ao longo do ano letivo**. |
...
| ID | História de Usuário |
|----|---------------------|
| **US15** | Como **administrador**, quero **pré-cadastrar professores no sistema vinculando-os às suas respectivas instituições**, para **que eles possam acessar o sistema e distribuir moedas aos alunos**. |
| **US16** | Como **administrador**, quero **pré-cadastrar as instituições de ensino parceiras no sistema**, para **que os alunos possam selecioná-las no momento do cadastro**. |
