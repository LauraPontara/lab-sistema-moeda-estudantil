        ...
        <div className="border-t-[3px] border-border bg-background/98 lg:hidden">
          <nav className="flex flex-col px-5 py-4" aria-label="Menu mobile">
            ...
            <div className="mt-4 flex flex-col gap-3 pb-2">
              ...
              <AnimatedThemeToggler
                variant="circle"
                className="flex h-12 items-center justify-center gap-2 rounded-full border-[3px] border-border bg-surface font-bold text-sm text-foreground shadow-toon transition-all active:translate-x-0.5 active:translate-y-0.5 active:shadow-none"
              />
            </div>
          </nav>
        </div>
